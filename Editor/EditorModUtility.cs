...
{
    public static class EditorModUtility
    {
        public static bool TryGetExpectedResourceKey(Object asset, out string key, out ModInfo mod)
        {
        ...
        public static bool TryGetExpectedMod(Object asset, out ModInfo mod)
        {
